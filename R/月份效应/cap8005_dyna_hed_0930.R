###cap8005_dyna_hed_0930

strategy<-"cap8005_dyna_hed_0930"
strategy_p1<-"cap8005_dyna_hed"
strategy_p2<-"30"
equity_curve<-read.csv(file=paste("//128.1.223.221/team4share/实盘策略/仓位管理/",strategy,".csv",sep=""),stringsAsFactors=F)
...
source("//128.1.223.221/team4share/仓位管理/working codes/数据汇总.R")