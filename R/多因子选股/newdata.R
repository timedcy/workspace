...
aaaaa<-read.csv('zz500weight_20150430.csv',stringsAsFactors=F)  #某天zz500收盘后比例
...
#08-09-17 all_A
#all_A<-read.csv('allA_06_09_27.csv',stringsAsFactors=F)
#all_A=as.data.frame(all_A)
#code_industry<-as.data.frame(industry)
#all_A<-merge(all_A,code_industry,by.x="trade_code",by.y="Code")
#all_A<-all_A[,1]
